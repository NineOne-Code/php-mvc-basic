    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <ul class="list-group">
              ...
              <li class="list-group-item"><?= $row['nama'] ?>
                  <a href="<?= BASEURL ?>/mahasiswa/hapus/<?= $row['id'] ?>" class="badge badge-danger float-right ml-1" onClick="return confirm('anda yakin?')">hapus</a>
                  <a href="<?= BASEURL ?>/mahasiswa/ubah/<?= $row['id'] ?>" class="badge badge-warning float-right ml-1 tampilModalUbah" data-toggle="modal" data-target="#formModal" data-id="<?= $row['id'] ?>">ubah</a>
                  <a href="<?= BASEURL ?>/mahasiswa/detail/<?= $row['id'] ?>" class="badge badge-primary float-right">detail</a>
              </li>
              <?php endforeach ?>
            </ul>
        </div>
